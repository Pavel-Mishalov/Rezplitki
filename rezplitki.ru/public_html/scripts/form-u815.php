<?php
	...
	<html>
	    ...
	    <body>
	        <p>Заказ на накладную ступень с доборами D-3:</p>
          <ul>
            <li>Имя: ' . $_POST['custom_U816'] . '</li>
            <li>Телефон: ' . $_POST['custom_U832'] . '</li>
            <li>Почта: ' . $_POST['custom_U820'] . '</li>
            <li>Пожелание по заказу: ' . $_POST['custom_U828'] . '</li>
          </ul>
	    </body>
	</html>';
