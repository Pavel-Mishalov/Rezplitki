<?php
	...
	<html>
	    ...
	    <body>
	        <p>Заказ на доставку:</p>
          <ul>
            <li>Имя: ' . $_POST['custom_U1551'] . '</li>
            <li>Телефон: ' . $_POST['custom_U1555'] . '</li>
            <li>Почта: ' . $_POST['custom_U1547'] . '</li>
            <li>Пожелание по заказу: ' . $_POST['custom_U1561'] . '</li>
          </ul>
	    </body>
	</html>';
