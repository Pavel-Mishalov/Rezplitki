<?php
	...
	<html>
	    ...
	    <body>
	        <p>Заказ на накладную ступень с доборами D-1:</p>
          <ul>
            <li>Имя: ' . $_POST['custom_U890'] . '</li>
            <li>Телефон: ' . $_POST['custom_U886'] . '</li>
            <li>Почта: ' . $_POST['custom_U894'] . '</li>
            <li>Пожелание по заказу: ' . $_POST['custom_U882'] . '</li>
          </ul>
	    </body>
	</html>';
