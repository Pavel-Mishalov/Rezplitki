<?php
	...
	<html>
	    ...
	    <body>
	        <p>Заказ на накладную забежную ступень (простая):</p>
          <ul>
            <li>Имя: ' . $_POST['custom_U646'] . '</li>
            <li>Телефон: ' . $_POST['custom_U655'] . '</li>
            <li>Почта: ' . $_POST['custom_U650'] . '</li>
            <li>Пожелание по заказу: ' . $_POST['custom_U661'] . '</li>
          </ul>
	    </body>
	</html>';
