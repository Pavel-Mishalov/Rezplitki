<?php
	...
	<html>
	    ...
	    <body>
	        <p>Заказ на накладную ступень (с двойной подклейкой на 45 градусов):</p>
          <ul>
            <li>Имя: ' . $_POST['custom_U520'] . '</li>
            <li>Телефон: ' . $_POST['custom_U525'] . '</li>
            <li>Почта: ' . $_POST['custom_U516'] . '</li>
            <li>Пожелание по заказу: ' . $_POST['custom_U530'] . '</li>
          </ul>
	    </body>
	</html>';
